...
CREATE TABLESPACE TS_USERS
  DATAFILE 'ts_users01.dbf' SIZE 100M
...
CREATE TABLESPACE TS_MATERIELS_CERGY
  DATAFILE 'ts_mat_cergy01.dbf' SIZE 200M
...
CREATE TABLESPACE TS_MATERIELS_PAU
  DATAFILE 'ts_mat_pau01.dbf' SIZE 200M
  AUTOEXTEND ON NEXT 50M MAXSIZE 2G
  EXTENT MANAGEMENT LOCAL UNIFORM SIZE 2M
  SEGMENT SPACE MANAGEMENT AUTO;
...
CREATE TABLESPACE TS_RESEAU
  DATAFILE 'ts_reseau01.dbf' SIZE 150M
...
CREATE TABLESPACE TS_INDEX
  DATAFILE 'ts_index01.dbf' SIZE 200M
  AUTOEXTEND ON NEXT 50M MAXSIZE 2G
  EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M
  SEGMENT SPACE MANAGEMENT AUTO;
...
CREATE TABLESPACE TS_AUDIT
  DATAFILE 'ts_audit01.dbf' SIZE 100M
...
CREATE TABLESPACE TS_MVIEWS
  DATAFILE 'ts_mviews01.dbf' SIZE 150M
  AUTOEXTEND ON NEXT 30M MAXSIZE 1G
  EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M
  SEGMENT SPACE MANAGEMENT AUTO;
...
CREATE PROFILE GLPI_SECURITE LIMIT
  ...
  PASSWORD_LIFE_TIME      90         -- 90 jours
  PASSWORD_REUSE_TIME     365
  PASSWORD_REUSE_MAX      5
  PASSWORD_VERIFY_FUNCTION ORA12C_STRONG_VERIFY_FUNCTION
  SESSIONS_PER_USER       10
  IDLE_TIME               60         -- déconnexion après 60 min d'inactivité
  CONNECT_TIME            480;       -- 8 heures max par session
